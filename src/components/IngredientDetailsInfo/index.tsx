...
const IngredientDetailsInfo = ({ ingredientDetails }: IngredientDetailsProps) => {
    ...
    return (
        <div>
            ...
            <h2 className={["text text_type_main-medium mb-4", styles.details_title].join(' ')}>{name}</h2>
...
export default IngredientDetailsInfo;